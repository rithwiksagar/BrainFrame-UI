...
export default function Home() {
  return (
    ...
    >
      ...
      <h4 className="text-md md:text-xl lg:text-2xl mt-2 text-neutral-500 md:max-w-160">
        Premium, production-ready AI components with polished interactions and zero styling headaches.
      </h4>
      <div className="flex gap-4 mt-6">
        <Link
          href={"/docs/introduction"}
          className=" bg-neutral-800/96 dark:bg-white/95 text-white hover:bg-neutral-900/95 dark:hover:bg-white/90
         dark:text-neutral-900 border border-neutral-700/20 px-3 lg:px-4 py-1.5 rounded-lg text-[15px] lg:text-[18px] cursor-pointer
         flex items-center"
        >
          Get Started
          <ArrowUpRight 
          className="size-5 ml-2"></ArrowUpRight>
        </Link>
      </div>
      <div
