...
const linkClassName =
  "w-fit text-sm text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-white";

export default function Footer() {
  return (
    <footer className="w-full text-neutral-900 dark:border-neutral-800 dark:bg-neutral-950 dark:text-white md:px-10">
      ...
      <div className="mt-20 mb-6 text-sm text-neutral-500 dark:border-neutral-800 dark:text-neutral-400">
